...
class SignupController extends GetxController {
  ...
  void signup() async {
    try {
      TFullScreenLoader.openLoadingDialog('Processing your information...', TImages.shopAnimation);
      ...
      final UserCredential userCredential = await AuthenticationRepository.instance.registerWithEmailAndPassword(
          email.text.trim(),
          password.text.trim()
      );
      ...
      // Subscribe to default topics after sign up
      await _fcmService.subscribeToDefaultTopics();
